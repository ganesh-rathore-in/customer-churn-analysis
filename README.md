...
|-----------|-------------|
| `Formatted_Customers_Churn_Analysis.ipynb` | Full Python notebook with structured analysis, visualizations, and business insights |
| `Customers_Churn_Analysis.html` | Rendered HTML report view of the notebook (for quick preview without Jupyter) |
...
- Higher **monthly charges** often correlate with customer loss.
